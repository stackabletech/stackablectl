...
:latest-release: https://github.com/stackabletech/stackablectl/releases/tag/stackablectl-1.5.2
...
[source,console]
----
$ curl -L -o stackablectl https://github.com/stackabletech/stackablectl/releases/download/stackablectl-1.5.2/stackablectl-x86_64-unknown-linux-gnu
----
...
[source,console]
----
$ curl -L -o stackablectl https://github.com/stackabletech/stackablectl/releases/download/stackablectl-1.5.2/stackablectl-aarch64-unknown-linux-gnu
----
...
[source,console]
----
$ curl -L -o stackablectl https://github.com/stackabletech/stackablectl/releases/download/stackablectl-1.5.2/stackablectl-x86_64-apple-darwin
----
...
[source,console]
----
$ curl -L -o stackablectl https://github.com/stackabletech/stackablectl/releases/download/stackablectl-1.5.2/stackablectl-aarch64-apple-darwin
----
