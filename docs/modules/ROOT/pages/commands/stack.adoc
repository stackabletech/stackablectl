...
It is tied to a specific release of the Stackable Data Platform, which will provide the needed operators for the Stack.
...
Detailed information of a stack can queried with the `describe` command:
