...
If you just wan't an easy way to get started or don't know which products and/or which version to install it is recommended to use the xref:commands/release.adoc[] command.
This command will install a bundle of operators from a official Stackable Release.
