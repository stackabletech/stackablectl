...
As of writing (2022/08/10) only a single demo is available, but further demos will be added in the future.
...
The demos create Kubernetes jobs, that will populate testdata and talk to the installed products to process the data.
