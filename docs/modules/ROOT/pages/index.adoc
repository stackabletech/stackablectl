...
It also ships with a set of pre-build demos that utilize different data products of the Platform to get e.g. an end-to-end data pipeline.
...
Often you can also use a abbreviation instead of typing out all of the commands.
...
== Demos
A demo is a end-to-end demonstration of the usage of the Stackable Data Platform.
It contains
