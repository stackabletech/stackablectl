...
You can connect to the shell via `kubectl exec -it hbase-master-default-0 -- bin/hbase shell`.
...
== The Hbase UI
The Hbase web UI will give you information on status and metrics of your Hbase cluster. See below for the startpage.
