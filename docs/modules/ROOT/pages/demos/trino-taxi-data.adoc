...
* 6.8 https://kubernetes.io/docs/tasks/debug/debug-cluster/resource-metrics-pipeline/#cpu[cpu units] (core/hyperthread)
* 16GiB memory
* 28GiB disk storage
...
To put it simply you just have to run `stackablectl demo install trino-taxi-data`.
