...
`stackablectl` is build in a way customers or developers can define their own releases, stacks and demos!
...
=== Adding a new demo
First you must create a `mycorp-demos.yaml` containing demos according to the format defined by https://github.com/stackabletech/stackablectl/blob/main/demos/demos-v1.yaml[the Stackable provided demos].
